...
App::App()
{
	...
	UnhandledException += ref new Windows::UI::Xaml::UnhandledExceptionEventHandler(this, &GoogleAnalytics_Sample_Native::App::OnUnhandledException);
	 
}


Tracker^ App::tracker = nullptr; 
...
void GoogleAnalytics_Sample_Native::App::OnUnhandledException(Platform::Object ^sender, Windows::UI::Xaml::UnhandledExceptionEventArgs ^e)
{
	e->Handled = true;  
}
